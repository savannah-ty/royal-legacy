...
const RoyalLegacyApp = {
    ...
    deleteChildData() {
        this.showConfirmModal('Delete All Data', 'Are you sure you want to delete all your child\'s game data? This cannot be undone!', () => {
            // 清除所有数据
    ...
    clearAllData() {
        this.showConfirmModal('Clear All Data', 'Are you sure you want to clear all game data? This cannot be undone!', () => {
            // 清理前的数据统计
            const beforeData = {
